...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  forecasts = {
     ...
     *
     * @tags forecasts
     * @name ForecastsUpdatePriceUpdate
     * @request PUT:/forecasts/{forecast_id}/update_price/
     * @secure
     */
    forecastsUpdatePriceUpdate: (forecastId: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/forecasts/${forecastId}/update_price/`,
        method: "PUT",
        secure: true,
        ...params,
      }),
